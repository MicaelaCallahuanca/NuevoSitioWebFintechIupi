    ...
    <section className="relative min-h-screen flex items-center justify-center gradient-hero overflow-hidden pt-16">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Una app que te enseña a ahorrar e invertir sin riesgo,
            sin tecnicismos y sin sensación de "esto no es para mí".
          </motion.p>
          ...
          >
            <Button variant="cta" size="lg" className="rounded-full text-base px-8 h-12">
              Simular ahora
              <ArrowRight className="ml-1" size={18} />
            </Button>
            <Button variant="cta-outline" size="lg" className="rounded-full text-base px-8 h-12">
              Conocer más
            </Button>
          </motion.div>
